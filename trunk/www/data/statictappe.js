define({
  tappe: [{ 
    ...
    domanda: "Come si chiamava la prima università per \"farmacisti\"?",
  ...
  { 
    ...
    intro: ["Il Collegio Romano era il principale seminario gesuita romano. Fondato da Ignazio di Loyola nel 1551. Nel 1787 Giuseppe Calandrelli  qui fondò  l'Osservatorio Astronomico.", 
        ...
        "Gli astronomi del Collegio Romano inviavano il segnale ai militari sul tetto di Castel Sant\'Angelo tramite una cesta di vimini nera, che veniva lasciata scorrere lungo un palo nel momento preciso in cui il sole segnava le 12 su una meridiana." 
    ],
  ...
  { 
    ...
    intro: ["22 giugno 1633 Galileo Galilei nel convento di Santa Maria sopra Minerva, al termine del processo che lo vide imputato di fronte l'Inquisizione nel 1633, firma l’Abiura.",
        ...
        "Questo metodo si contrappone all’ osservazione passiva di un fenomeno ed a spiegazioni acritiche o legate alla pura immaginazione. Si basa sull’ utilizzo di esperimenti riproducibili e indipendenti dall’osservatore o dal luogo dove si realizzano, e la registrazione di dati misurabili e oggettivi.",
        "Questo è il metodo per comprendere la natura, ma, in fin dei conti, vale anche per qualunque situazione la vita quotidiana ci proponga."
    ],
    domanda: "In che anno abiurò Galileo?",
  ...
  { 
    ...
    intro: ["Elena Freda si laurea in matematica con Guido Castelnuovo nel 1912 e in fisica con Orso Mario Corbino nel 1915 all\'Università di Roma “La Sapienza”. Dopo aver insegnato a Roma ed essere stata a Messina per un breve periodo, a causa della mancanza di prospettive solide per la sua carriera, torna a Roma nel \'24 per proseguire i suoi studi e l\'insegnamento.",
        ...
        "Il museo prende il nome dal direttore Padre Athanasius Kircher (1601/2-1680) che ne era il curatore ed il \"regista\".",  
        "Nel museo si potevano trovare: opere d'arte, reperti antichi, obelischi egiziani, animali impagliati e non mancavano reperti e macchinari più che stravaganti: statue che parlavano, una coda di Sirena, manichini volanti sospesi nell\'aria."
    ],
    domanda: "Quale strano reperto si poteva vedere all’interno del Museo Kircheriano?",
